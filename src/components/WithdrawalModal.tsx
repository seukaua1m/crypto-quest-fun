  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md mx-auto">
        ...
        <div className="my-6 p-4 rounded-lg bg-muted">
          ...
          <p className="text-muted-foreground mb-4">Você precisa assistir um vídeo curto que explica como profissionais utilizam estas mesmas estratégias no mercado.</p>
        </div>
        ...
        scale: 0.95
          ...
          <Button size="lg" className="w-full flex items-center justify-center gap-2" onClick={handleRedirect}>
